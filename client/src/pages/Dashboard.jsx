import { Plus, PlusIcon, Upload, UploadCloudIcon } from 'lucide-react'
  ...
  return (
    <div>
        <div className='max-w-7xl mx-auto px-4 py-8'>
          <p className='text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'>Welcome, yuvi</p>
          ...
          {/* below logic to add line and view the resumes that user has already created basically user history */}
